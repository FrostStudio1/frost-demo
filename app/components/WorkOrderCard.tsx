...
export function WorkOrderCard({ workOrder }: WorkOrderCardProps) {
  ...
  return (
    <Link 
      ...
      className="block bg-white dark:bg-gray-800 rounded-lg shadow-md hover:shadow-lg transition-shadow border border-transparent dark:border-gray-700 hover:border-blue-500"
    >
...
export function WorkOrderCardSkeleton() {
  return (
    <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md border dark:border-gray-700 p-4 animate-pulse">
