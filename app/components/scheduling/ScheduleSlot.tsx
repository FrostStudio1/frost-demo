...
export function ScheduleSlot({
  ...
  return (
    <div
      ...
      className={`relative flex flex-col justify-between p-2.5 sm:p-2 space-y-1 bg-white dark:bg-gray-800 rounded-lg shadow-md hover:shadow-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 border-l-4 ${finalBorderColor} cursor-grab active:cursor-grabbing touch-none min-h-[44px] touch-manipulation active:scale-[0.98] transition-transform`}
