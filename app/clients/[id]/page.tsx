        ...
        <div className="p-4 sm:p-6 lg:p-10 max-w-7xl mx-auto w-full">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6 mb-6 sm:mb-8">
            <div className="bg-white dark:bg-gray-800 rounded-xl sm:rounded-2xl shadow-lg p-4 sm:p-6 border border-gray-100 dark:border-gray-700">
              ...
              <div className="text-2xl sm:text-3xl font-black text-blue-600 dark:text-blue-400">{projects.length}</div>
            </div>
            <div className="bg-white dark:bg-gray-800 rounded-xl sm:rounded-2xl shadow-lg p-4 sm:p-6 border border-gray-100 dark:border-gray-700">
              <div className="text-sm sm:text-base text-gray-500 dark:text-gray-400 mb-1 sm:mb-2">Totala timmar</div>
              <div className="text-2xl sm:text-3xl font-black text-purple-600 dark:text-purple-400">{totalHours.toFixed(1)}h</div>
            </div>
            <div className="bg-white dark:bg-gray-800 rounded-xl sm:rounded-2xl shadow-lg p-4 sm:p-6 border border-gray-100 dark:border-gray-700">
              <div className="text-sm sm:text-base text-gray-500 dark:text-gray-400 mb-1 sm:mb-2">Omsättning</div>
              <div className="text-2xl sm:text-3xl font-black text-green-600 dark:text-green-400">{totalRevenue.toLocaleString('sv-SE')} kr</div>
            </div>
          </div>

          {/* Client Info */}
          <div className="bg-white dark:bg-gray-800 rounded-xl sm:rounded-2xl shadow-lg p-6 sm:p-8 mb-6 sm:mb-8 border border-gray-100 dark:border-gray-700">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl sm:rounded-2xl shadow-lg p-6 sm:p-8 mb-6 sm:mb-8 border border-gray-100 dark:border-gray-700">
            <div className="flex items-center justify-between mb-4 sm:mb-6">
              ...
              <button
                ...
                className="px-4 py-2 bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 text-white rounded-lg font-semibold hover:shadow-lg transition-all text-sm sm:text-base"
              >
                + Nytt projekt
              </button>
            </div>
          ...
          {/* Invoices */}
          <div className="bg-white dark:bg-gray-800 rounded-xl sm:rounded-2xl shadow-lg p-6 sm:p-8 border border-gray-100 dark:border-gray-700">
