    ...
    <div className="min-h-screen bg-white dark:bg-gray-900 flex flex-col lg:flex-row">
      ...
      <main className="flex-1 w-full lg:ml-0 overflow-x-hidden">
        <div className="p-4 sm:p-6 lg:p-10 max-w-4xl mx-auto w-full">
          ...
          <div className="mb-6 bg-yellow-50 dark:bg-yellow-900/20 border-2 border-yellow-300 dark:border-yellow-700 rounded-xl sm:rounded-2xl p-4 sm:p-6">
          ...
          <div className="mb-6 sm:mb-8 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            ...
            <button
              onClick={() => router.back()}
              className="w-full sm:w-auto px-6 py-3 rounded-xl border-2 border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 font-semibold hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors"
            >
              Tillbaka
            </button>
          </div>
          ...
          {/* Status Card */}
          <div className="bg-white dark:bg-gray-800 rounded-xl sm:rounded-2xl shadow-lg p-4 sm:p-6 lg:p-8 border border-gray-100 dark:border-gray-700 mb-6">
            ...
            <div className="flex flex-wrap gap-3 mt-4">
              {application.status === 'draft' && (
                <button
                  ...
                  disabled={submitting}
                  className="bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 text-white px-6 py-3 rounded-xl font-bold shadow-lg hover:shadow-xl transition-all disabled:opacity-50 disabled:cursor-not-allowed transform hover:scale-105 disabled:transform-none"
                >
              ...
              {['submitted', 'under_review'].includes(application.status) && (
                <button
                  ...
                  className="bg-gradient-to-r from-purple-500 to-blue-500 text-white px-6 py-3 rounded-xl font-bold shadow-lg hover:shadow-xl transition-all disabled:opacity-50 disabled:cursor-not-allowed"
                >
              ...
              {application.status === 'approved' && (
                <button
                  ...
                  className="bg-gradient-to-r from-green-500 to-emerald-500 text-white px-6 py-3 rounded-xl font-bold shadow-lg hover:shadow-xl transition-all transform hover:scale-105"
                >
              ...
              {application.status === 'rejected' && (
                <div className="flex flex-wrap gap-3">
                  <button
                    ...
                    className="bg-gradient-to-r from-orange-500 to-red-500 text-white px-6 py-3 rounded-xl font-bold shadow-lg hover:shadow-xl transition-all transform hover:scale-105"
                  >
                    Överklaga
                  </button>
                  <button
                    onClick={handleCreateInvoice}
                    className="bg-gradient-to-r from-gray-500 to-gray-600 text-white px-6 py-3 rounded-xl font-bold shadow-lg hover:shadow-xl transition-all"
                  >
          ...
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl max-w-md w-full p-6">
            ...
            <div className="space-y-3">
              <a
                ...
                className="block w-full bg-gradient-to-r from-blue-500 to-purple-500 text-white px-6 py-3 rounded-xl font-bold text-center shadow-lg hover:shadow-xl transition-all transform hover:scale-105"
              >
                Öppna Skatteverkets ROT/RUT-sida
              </a>
              <button
                onClick={() => setShowBankIdModal(false)}
                className="w-full px-6 py-3 rounded-xl border-2 border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 font-semibold hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors"
              >
                Stäng
              </button>
            </div>
