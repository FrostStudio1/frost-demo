...
-- ============================================================================
-- Notes:
-- - current_tenant_id() reads from JWT app_metadata.tenant_id (authoritative)
-- - Falls back to employees table query if JWT claim missing (legacy support)
-- - All policies now use claim-based checks instead of subqueries (better performance)
-- - DELETE policy added for aeta_requests
-- ============================================================================
