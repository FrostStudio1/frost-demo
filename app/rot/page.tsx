    ...
    <div className="min-h-screen bg-white dark:bg-gray-900 flex flex-col lg:flex-row">
      ...
      <main className="flex-1 w-full lg:ml-0 overflow-x-hidden">
        <div className="p-4 sm:p-6 lg:p-10 max-w-7xl mx-auto w-full">
          ...
          {/* List */}
          {loading ? (
            <div className="bg-white dark:bg-gray-800 rounded-xl sm:rounded-2xl shadow-lg p-12 text-center text-gray-500 dark:text-gray-400">
              Laddar...
            </div>
          ) : applications.length === 0 ? (
            <div className="bg-white dark:bg-gray-800 rounded-xl sm:rounded-2xl shadow-lg p-8 text-center text-gray-500 dark:text-gray-400">
