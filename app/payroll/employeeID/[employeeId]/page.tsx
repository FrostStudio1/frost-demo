      ...
      <main className="flex-1 lg:ml-0 overflow-x-hidden">
        <div className="p-4 sm:p-6 lg:p-10 max-w-4xl mx-auto w-full">
          <div className="mb-6 sm:mb-8 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div>
              <h1 className="text-3xl sm:text-4xl font-black text-gray-900 dark:text-white mb-1 sm:mb-2">Lönespec</h1>
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              ...
              <button
                onClick={() => router.back()}
                className="px-6 py-3 rounded-xl border-2 border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 font-semibold hover:bg-gray-50 dark:hover:bg-gray-700 hover:border-gray-400 dark:hover:border-gray-500 transition-colors"
              >
                Tillbaka
              </button>
            </div>
          ...
          <div className="mb-6">
            ...
            <select
              ...
              className="w-full sm:w-auto px-4 py-3 rounded-xl border-2 border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-all hover:border-gray-300 dark:hover:border-gray-600"
            >
          ...
          <div id="payslip-content" className="bg-white dark:bg-gray-800 rounded-xl sm:rounded-2xl shadow-lg border border-gray-100 dark:border-gray-700 p-4 sm:p-6 lg:p-8">
            ...
            <div className="bg-gradient-to-r from-blue-50 to-purple-50 dark:from-blue-900/20 dark:to-purple-900/20 rounded-xl p-6 space-y-3 border border-blue-200 dark:border-blue-800">
              ...
              <div className="flex justify-between pt-3 border-t-2 border-gray-300 dark:border-gray-600 text-xl">
                ...
                <span className="font-black text-purple-600 dark:text-purple-400">{sek(net)}</span>
              </div>
            </div>
          </div>
        </div>
