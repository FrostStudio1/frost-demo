            ...
            <div className="space-y-3">
              {validTransitions.map((transition) => (
                <button
                  ...
                  className="w-full sm:w-auto min-w-[200px] px-6 py-3 text-base font-semibold rounded-lg shadow-md bg-blue-600 text-white hover:bg-blue-700 disabled:opacity-50 disabled:cursor-not-allowed transition-all transform hover:scale-105 flex items-center justify-center gap-2"
                >
